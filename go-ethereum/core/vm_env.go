...
Do not support this function in Gcoin
*/
...
Do not support this fn in Gcoin
*/ 
...
func (self *VMEnv) Call(me vm.ContractRef, addr common.Address, data []byte, gas, price *big.Int, value map[uint]*big.Int) ([]byte, error) {
	return Call(self, me, addr, data, gas, price, value)
}
func (self *VMEnv) CallCode(me vm.ContractRef, addr common.Address, data []byte, gas, price *big.Int, value map[uint]*big.Int) ([]byte, error) {
...
func (self *VMEnv) Create(me vm.ContractRef, data []byte, gas, price *big.Int, value map[uint]*big.Int) ([]byte, common.Address, error) {
