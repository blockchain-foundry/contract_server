...
contract RecoverableController {
    ...
    //Brian
    function getRecoveryKey() constant returns (address){ return recoveryKey; }
    function getUserkey() constant returns (address){ return userKey; }
    function getProposedUserKey() constant returns(address){return proposedUserKey;}
...
contract RecoveryQuorum {
    ...
    function getAddressesNum() constant returns (uint){return delegateAddresses.length;}
