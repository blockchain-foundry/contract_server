...
urlpatterns = [
    ...
    url(r'^subcontracts/(?P<multisig_address>[A-Za-z0-9]+)/', views.SubContract.as_view()),
    url(r'^subcontracts/(?P<multisig_address>[A-Za-z0-9]+)/function', views.SubContractFunc.as_view()),
