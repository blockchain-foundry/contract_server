...
urlpatterns = [
    ...
    url(r'^multisig-addresses/(?P<state_multisig_address>[A-Za-z0-9]+)/contracts/(?P<contract_address>[A-Za-z0-9]+)/function/$', views.ContractFunction.as_view()),
    url(r'^multisig-addresses/(?P<multisig_address>[A-Za-z0-9]+)/contracts/(?P<contract_address>[A-Za-z0-9]+)/$', views.ContractAddressList.as_view()),
    url(r'^contracts/deploy$', views.DeployContract.as_view()),
